<div class="overflow-hidden rounded-xl border border-gray-200 shadow-sm dark:border-gray-700 dark:bg-gray-900 bg-white">
    {{-- Header (Desktop Only) --}}
    <div class="hidden sm:grid grid-cols-12 bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-400 font-medium border-b dark:border-gray-700">
    ...
    <div class="divide-y divide-gray-100 dark:divide-gray-700">
        ...
        @forelse($products as $product)
            ...
            @endphp
            <div class="sm:grid sm:grid-cols-12 bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                {{-- Product Info --}}
                <div class="col-span-5 px-4 py-4 sm:px-8 sm:py-4 flex items-center gap-4">
                    @if($image)
                        <img src="{{ $image }}" alt="{{ $product['name'] }}" class="rounded-lg bg-gray-50 dark:bg-gray-800 border dark:border-gray-700 w-16 h-16 sm:w-20 sm:h-20 object-contain flex-shrink-0">
                    @else
                        <div class="rounded-lg bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-400 w-16 h-16 sm:w-20 sm:h-20 flex-shrink-0">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        {{-- Mobile details shown under name --}}
                        <div class="sm:hidden mt-3 flex flex-wrap items-center gap-3">
                ...
                {{-- Mobile Total Row (Visual split) --}}
                <div class="sm:hidden px-4 pb-4 flex justify-between items-center border-t border-gray-50 dark:border-gray-800 pt-3">
                ...
                {{-- Desktop Quantity --}}
                <div class="hidden sm:flex col-span-2 px-2 py-4 items-center justify-center">
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <div class="mt-1 flex flex-col items-center gap-1">
                                ...
                                @if(isset($product['discount_end_date']))
                                    <span class="text-[10px] text-red-600 dark:text-red-400 flex items-center gap-1">
                                        Exp: {{ \Carbon\Carbon::parse($product['discount_end_date'])->format('d/m/Y') }}
                                    </span>
                                @endif
                            </div>
                        </div>
                ...
                {{-- Desktop Total --}}
                <div class="hidden sm:flex col-span-3 px-8 py-4 items-center justify-end">
